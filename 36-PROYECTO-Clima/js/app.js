...
function mostrarError(mensaje) {
    ...
    if(!alerta) {
        ...
        // Que se elimine el alerta dsp de 3 segundos
...
function consultarAPI(ciudad, pais) {
    ...
    const appId = '3fa27b13bd44cdd278993cb82ed64b05';
...
function mostrarClima(datos) {
    ...
    nombreCiudad.classList.add('font-ligth', 'text-2xl');

    const actual = document.createElement('p'); 
    actual.innerHTML = `${centigrados} &#8451;`;
    actual.classList.add('font-ligth', 'text-6xl');
...
function mostrarImagenes() {
    ...
    const imagenes = ['2.webp', '3.webp', '1.webp', ]
